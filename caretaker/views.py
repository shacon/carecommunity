...
def signup(request):   
	if request.method == 'POST':
		...
		return render(request, 'caretaker/sign_up.html', {'form': form, 'errors': "Something went wrong"})
	else:
            form = Signup()
	    return render(request, 'caretaker/sign_up.html', {'form': form})
...
def thanks(request):
	return render(request, 'caretaker/thanks.html', {})
